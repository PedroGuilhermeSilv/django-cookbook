...
COPY --chown=myproject ./myproject_website/src/django-myproject/requirements /home/myproject/requirements/
RUN ./env/bin/pip3 install -r /home/myproject/requirements/${PIP_REQUIREMENTS}

# copy Django project files
COPY ./myproject_website/src/django-myproject /home/myproject/